...
function preload() {
    ...
    noiseWarpShader = readShader('/showcase/docs/Shaders/fragments/noiseWarpShader.frag');
    godraysShader = readShader('/showcase/docs/Shaders/fragments/godraysShader.frag');
  }
